...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../../../foto/misc/'); //accept relative path only
	//define('CONFIG_SYS_DEFAULT_PATH', '../../../.././../../../i/tinymce/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../../../foto/misc/');	//accept relative path only
