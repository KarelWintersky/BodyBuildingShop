...
class f_Register
{
    ...
    public function path_check()
    {
        ...
        if (isset( $_SESSION[ 'user_id' ] ) && !isset( $_SESSION[ 'allow_reg_page' ] )) {
    ...
    public function step_2()
    {
        ...
        if ($_POST[ 'city' ] == '') {
            $err_array[] = 'Укажите город';
        }
        
        if ($_POST[ 'street' ] == '') {
            $err_array[] = 'Укажите улицу';
        }
        
        if ($_POST[ 'house' ] == '') {
            $err_array[] = 'Укажите номер дома';
        }
        
        if (!isset( $_POST[ 'terms' ] )) {
            $err_array[] = 'Нужно согласиться с правилами';
        }
