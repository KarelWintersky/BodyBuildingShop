...
class Catalog
{
    ...
    private function goods_check($level_parent_id, $level_id, $goods_id)
    {
        ...
        if (($level_parent_id == 0 && $goods_id != 0) || !is_numeric( $level_parent_id ) || !is_numeric( $level_id ) || !is_numeric( $goods_id )) {
            return false;
        }
    ...
    private function level_check($parent_id, $level_id)
    {
        ...
        if (!is_numeric( $parent_id ) || !is_numeric( $level_id )) {
            return false;
        }
    ...
    public function goods_del($goods_id = 0)
    {
        ...
        if (mysql_affected_rows() > 0) {
            $photomanager->unlink_images( '', $goods_id, true );
        }
    ...
    public function goods_features_upd($goods_id)
    {
