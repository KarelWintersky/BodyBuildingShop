...
class Adm_News_Save
{
    ...
    public function do_save()
    {
        ...
        $longtitle = ($longtitle) ? $longtitle : $name;         // exported
        $alias = $this->do_alias( $alias, $name, $id, $type );  // exported
        
        $content = Adm_Helper_Content::delete_junk( $content ); // exported
        $content = Adm_Helper_Content::div_replace( $content ); // exported
