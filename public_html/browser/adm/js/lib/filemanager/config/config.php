...
$upload_dir = '/data/foto/misc/'; // path from base_url to base of upload folder (with start and final /)
//$current_path = '../../../../../../data/tinymce/'; // relative path from filemanager folder to upload folder (with final /)
$current_path = '../../../../../data/foto/misc/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../../data/foto/miscthumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
